...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Decision.voting'
        db.add_column('voting_decision', 'voting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='decisions', null=True, to=orm['voting.Voting']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Voting.decision'
        db.add_column('voting_voting', 'decision', self.gf('django.db.models.fields.related.OneToOneField')(related_name='voting', unique=True, null=True, to=orm['voting.Decision'], blank=True), keep_default=False)
