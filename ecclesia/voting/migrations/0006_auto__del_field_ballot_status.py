...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Ballot.status'
        db.delete_column('voting_ballot', 'status')


    def backwards(self, orm):
        
        # We cannot add back in field 'Ballot.status'
        raise RuntimeError(
            "Cannot reverse this migration. 'Ballot.status' and its values cannot be restored.")
    ...
    models = {
        ...
        'voting.voting': {
            'Meta': {'ordering': "['-end_time']", 'object_name': 'Voting'},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Started'", 'max_length': '50'}),
