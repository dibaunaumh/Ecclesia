...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('voting_decision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='decision', to=orm['voting.Voting'])),
            ('discussion', self.gf('django.db.models.fields.related.ForeignKey')(related_name='decision', to=orm['discussions.Discussion'])),
            ('decision_story', self.gf('django.db.models.fields.related.ForeignKey')(related_name='decision', to=orm['discussions.Story'])),
            ('percent_of_ballots', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('voting', ['Decision'])


    def backwards(self, orm):
        
        # Deleting model 'Decision'
        db.delete_table('voting_decision')
    ...
    models = {
        ...
        'voting.decision': {
            ...
            'decision_story': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'decision'", 'to': "orm['discussions.Story']"}),
            'discussion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'decision'", 'to': "orm['discussions.Discussion']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percent_of_ballots': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'voting': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'decision'", 'to': "orm['voting.Voting']"})
        },
        'voting.voting': {
