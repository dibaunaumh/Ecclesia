...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpeechAct.icon'
        db.alter_column('discussions_speechact', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SpeechAct.icon'
        db.alter_column('discussions_speechact', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=25, null=True, blank=True))
