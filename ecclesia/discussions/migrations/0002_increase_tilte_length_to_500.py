...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opinion.title'
        db.alter_column('discussions_opinion', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))

        # Changing field 'Opinion.slug'
        db.alter_column('discussions_opinion', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))

        # Changing field 'StoryRelation.title'
        db.alter_column('discussions_storyrelation', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))

        # Changing field 'StoryRelation.slug'
        db.alter_column('discussions_storyrelation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))

        # Changing field 'Story.title'
        db.alter_column('discussions_story', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))

        # Changing field 'Story.slug'
        db.alter_column('discussions_story', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Opinion.title'
        db.alter_column('discussions_opinion', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'Opinion.slug'
        db.alter_column('discussions_opinion', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'StoryRelation.title'
        db.alter_column('discussions_storyrelation', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'StoryRelation.slug'
        db.alter_column('discussions_storyrelation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Story.title'
        db.alter_column('discussions_story', 'title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Changing field 'Story.slug'
        db.alter_column('discussions_story', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
