...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discussion.thumbnail'
        db.add_column('discussions_discussion', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Discussion.thumbnail'
        db.delete_column('discussions_discussion', 'thumbnail')
