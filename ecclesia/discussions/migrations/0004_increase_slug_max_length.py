...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discussion.slug'
        db.alter_column('discussions_discussion', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Discussion.slug'
        db.alter_column('discussions_discussion', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
