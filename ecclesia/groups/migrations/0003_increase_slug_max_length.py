...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupProfile.slug'
        db.alter_column('groups_groupprofile', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=500))


    def backwards(self, orm):
        
        # Changing field 'GroupProfile.slug'
        db.alter_column('groups_groupprofile', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
