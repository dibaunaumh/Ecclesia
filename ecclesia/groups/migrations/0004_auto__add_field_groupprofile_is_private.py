...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupProfile.is_private'
        db.add_column('groups_groupprofile', 'is_private', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupProfile.is_private'
        db.delete_column('groups_groupprofile', 'is_private')
