...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.gravatar'
        db.add_column('groups_userprofile', 'gravatar', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.gravatar'
        db.delete_column('groups_userprofile', 'gravatar')
