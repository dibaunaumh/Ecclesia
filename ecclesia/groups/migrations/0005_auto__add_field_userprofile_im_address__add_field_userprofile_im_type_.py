...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.im_address'
        db.add_column('groups_userprofile', 'im_address', self.gf('django.db.models.fields.CharField')(max_length=500, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.im_type'
        db.add_column('groups_userprofile', 'im_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.receive_im_notification'
        db.add_column('groups_userprofile', 'receive_im_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'UserProfile.im_address'
        db.delete_column('groups_userprofile', 'im_address')

        # Deleting field 'UserProfile.im_type'
        db.delete_column('groups_userprofile', 'im_type')

        # Deleting field 'UserProfile.receive_im_notification'
        db.delete_column('groups_userprofile', 'receive_im_notification')
    ...
    models = {
        ...
        'groups.userprofile': {
            ...
            'receive_im_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
