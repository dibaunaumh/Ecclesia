...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notifications_notification', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.Group']), keep_default=False)
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
